...
export function AppMockup() {
  ...
  return (
    <div className="relative">
      <div
        aria-hidden
        className="bg-primary/20 pointer-events-none absolute -top-10 -left-10 size-56 rounded-full blur-3xl"
      />
      <div
        aria-hidden
        className="bg-secondary-glow/20 pointer-events-none absolute -right-10 -bottom-10 size-56 rounded-full blur-3xl"
      />

      <OrbitIcons />

      <div className="app-mockup-wobble">
        <motion.div
          ...
          style={{ rotate: tilt }}
          className="border-primary/20 bg-elevated shadow-glow-primary relative overflow-hidden rounded-xl border shadow-lg"
        >
          <div className="border-border bg-elevated-2 relative flex items-center gap-2 border-b px-4 py-3">
          ...
          <div className="relative overflow-hidden">
            <div className="app-mockup-scan pointer-events-none" />
